...
(102, 'Furniture', 'Comfortable Plastic Chair', 'Plastic', 'Plastic Chair', 2500),
(103, 'Furniture', '7 seater Sofa', 'Wood', 'Sofa', 19000),
(104, 'Crockery', '6 members family dinner set', 'Ceramic', 'Dinner Set', 5000),
(105, 'Crockery', 'Cooking essentials set', 'Steel', 'Cooking Set', 7500),
(106, 'Stationary', 'complete office need stationary set', 'Plastic', 'Office Sattionary Set', 20000),
